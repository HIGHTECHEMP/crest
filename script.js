...
function refreshUserUI() {
  ...
  updateAvatarImages(u.avatar_url);
    ...
    setText('currencyDisplay').textContent = u.currency + ' \u2014 ' + (u.currency==='EUR'?'Euro':u.currency==='USD'?'US Dollar':u.currency==='GBP'?'British Pound':'Nigerian Naira');
    setText('languageDisplay').textContent = LANGUAGE_NAMES[u.language] || 'English (US)';
